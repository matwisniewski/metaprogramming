...
public class Group implements FigureElement {
    private Collection<FigureElement> _members;
    private String _identifier;

    public Group(FigureElement first) {
        this._members = new ArrayList<FigureElement>();
        add(first);
    }
    ...
    public Iterator<FigureElement> members() {
        return _members.iterator();
    }

    public void move(int dx, int dy) {
        for (Iterator<FigureElement> i = _members.iterator(); i.hasNext(); ) {
